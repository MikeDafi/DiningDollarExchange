    ...
    <View style={{ flexDirection: "row" }}>
      ...
      >
        <View style={{ alignItems: "center", paddingHorizontal: 10 }}>
          ...
          <Text
            style={{ fontSize: 100, textAlign: "center", fontWeight: "700" }}
            adjustsFontSizeToFit={true}
            numberOfLines={1}
          >
            80%
      ...
      >
        <View style={{ alignItems: "center", paddingHorizontal: 10 }}>
          ...
          <Text
            style={{ fontSize: 100, textAlign: "center", color: "white" }}
            adjustsFontSizeToFit={true}
            numberOfLines={1}
          >
            Dining Dollar{" "}
          ...
          <Image
            source={require("../assets/diningdollar.png")}
            style={{
              resizeMode: "contain",
              height: 70,
              width: windowWidth / 2 - 70,
        ...
        <AwesomeButton
          ...
          onPress={() => {
            this.setState({ buyerPages: false });
            setTimeout(() => {
              this._swiper.scrollBy(1);
            }, 300);
          }}
      ...
      >
        ...
        {this.state.buyerPages != undefined ? (
          this.state.buyerPages ? (
            <Swiper
              ...
              style={{
                flexDirection: "row",
                backgroundColor: "rgba(255,227,0,0.3)",
                backgroundOpacity: "0",
              }}
            >
        ...
        >
          <View style={{ position: "absolute", left: 10 }}>
            <TouchableOpacity
              onPress={() => {
                if (this.state.buyerPages == undefined) {
                  this.props.navigation.goBack(null);
                } else {
                  this.setState({ buyerPages: undefined });
                }
              }}
            >
              <Text
