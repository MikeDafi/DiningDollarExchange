      ...
      >
        <View style={{ alignItems: "center" }}>
          ...
          <View style={styles.avatarPlaceholder}>
            <Image source={require("../assets/a.jpg")} style={styles.avatar} />
    ...
    return (
      <View
        style={[
          ...
          { height: (windowHeight - 280) / 2, alignItems: "flex-end" },
        ]}
      >
        ...
        >
          <Grid style={{ width: windowWidth }}>
            <Row style={{ marginBottom: 20 }} size={50}>
              ...
              <Col size={50}>{this.statisticsView()}</Col>
            </Row>
            <Row size={50}>
              <Col size={50}>{this.scheduleView()}</Col>
              <Col size={50}>{this.shareView()}</Col>
            </Row>
          </Grid>
        </View>
        <AwesomeButton
