...
export default class RegisterScreen extends React.Component {
  ...
  handleSignUp = async () => {
    ...
    firebase
      ...
      .catch((error) => {
         this.setState({emailError: "*Email already in use, Go to Login*"})
         })
  };
  ...
  handlePassword = (password) => {
    ...
    if (!password.match(atLeastOneNumber)) {
      ...
      this.setState({
        passwordError: "*Password must have at least one uppercase*",
      });
    } else if (!password.match(atLeastOneLowerCase)) {
      this.setState({
        passwordError: "*Password must have at least one lowercase*",
      });
    ...
    return (
      <View style={styles.container}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <ImageBackground
            source={require("../assets/yellowGradient1.jpg")}
            style={styles.image}
          >
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
            <KeyboardAvoidingView
            ...
            >
              <View style={styles.form}>
                ...
                <View
                  style={{ marginTop: this.state.nameError != "" ? 0 : 20 }}
                >
                ...
                <View
                  style={{ marginTop: this.state.emailError != "" ? 0 : 20 }}
                >
                  ...
                  <TextInput
                    ...
                    autoCapitalize="none"
                    secureTextEntry
                    onEndEditing={() => this.setState({focusedConfirmPassword:false})}
                ...
                <View
                  style={{
                    marginTop: this.state.passwordError != "" ? 0 : 20,
                    marginBottom:
                      this.state.confirmPasswordError != "" ? 0 : 20,
                  }}
                >
